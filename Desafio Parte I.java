...
public class CaixaRapidoDesafio {
    ...
    public static void main(String[] args) {
        ...
        int escolha, sair;
        double saldo_real = 100.00, saldo_dolar = 0.00, deposito, emprestimo,
                valor_parcela, parcela_max, salario, comprar_dolar, juros, total_parcela;
        String opcao;
            ...
            switch (escolha) {
                    ...
                    while (!deposito_valido) {
                        ...
                        if (deposito >= 0.01 && deposito <= 5000) {
                            ...
                            if (pos_extrato < extrato.length) {
                                extrato[pos_extrato] = deposito;
                                pos_extrato++;
                            } else {
                                for (int i = 0; i < extrato.length - 1; i++) {
                                    extrato[i] = extrato[i + 1];
                                }
                                extrato[extrato.length - 1] = deposito;
                            }
                        } else {
                ...
                case 3:
                    ...
                    for (int i = pos_extrato - 1; i >= 0; i--) {
                        if (extrato[i] != 0) {
                            System.out.println("Deposito +R$" + extrato[i]);
                            vazio = false;
                        }
                    }
                    if (vazio) {
                ...
                case 5:
                    ...
                    while (!conversao) {
                        ...
                        if (custo > saldo_real) {
                            System.out.println("Custo em Reais: R$" + custo);
                            ...
                            if (confirmacao.equalsIgnoreCase("S")) {
                                ...
                                System.out.println("Compra realizada com sucesso! \nNovo saldo: \n-Reais R$" + saldo_real + " \n-Dólares US$" + saldo_dolar);
                                if (pos_extrato < extrato.length) {
                                    extrato[pos_extrato] = quantidade;
                                    pos_extrato++;
                                } else {
                                    for (int i = 0; i < extrato.length - 1; i++) {
                                        extrato[i] = extrato[i + 1];
                                    }
                                    extrato[extrato.length - 1] = quantidade;
                                }
                            }
                            conversao = true;
                        }
